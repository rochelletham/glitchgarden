...
export default {
  ...
  mounted() {
    ...
    this.ansDelayTimeVal = generateAnswer(CHORUS_MIN_DELAY, CHORUS_MAX_DELAY);
    this.ansFeedbackGain = generateAnswer(0,CHORUS_FEEDBACK);
  ...
  methods: {
    ...
    checkAnswer(event) {
      ...
      checkAnswer("chorus", (this.delayTimeVal)*1000, this.feedbackGain, this.wetDryVal,

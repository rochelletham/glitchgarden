...
import {WHITE_CHORUS_MIN_DELAY} from '@/utils/effectProps.js';
import {WHITE_CHORUS_MAX_DELAY} from '@/utils/effectProps.js';
import {WHITE_CHORUS_FEEDBACK} from '@/utils/effectProps.js';
...
export default {
  ...
  mounted() {
    ...
    this.ansDelayTimeVal = generateAnswer(WHITE_CHORUS_MIN_DELAY, WHITE_CHORUS_MAX_DELAY);
    this.ansFeedbackGain = generateAnswer(0,WHITE_CHORUS_FEEDBACK);
...
<template>
  ...
  <div class="title">
    <h1 class="black">White Chorus</h1>

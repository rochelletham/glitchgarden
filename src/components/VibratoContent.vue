...
import {VIBRATO_MIN_DELAY} from '@/utils/effectProps.js';
import {VIBRATO_MAX_DELAY} from '@/utils/effectProps.js';
import {VIBRATO_FEEDBACK} from '@/utils/effectProps.js';
...
export default {
  ...
  mounted() {
    ...
    this.ansDelayTimeVal = generateAnswer(VIBRATO_MIN_DELAY, VIBRATO_MAX_DELAY);
...
<template>
  ...
  <div class="title">
    ...
    <div>
      ...
      name="Delay Duration" min="0.001" max="0.01" step="0.001" value="0.0" class="efx-slider" >
